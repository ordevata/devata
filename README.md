...
- `GET /api/v1/partners/payouts` — агрегированный снимок партнёрских начислений 26% с порогом 50 000 ₽ и журналом по каждому уровню.
...
## Демо-интерфейсы
- `/booking/new` — мастер записи с проверкой слотов и платёжными подсказками.
- `/client` — кабинет клиента с разделами по статусам, оплатами и историей визитов.
- `/specialists` — кабинет специалиста с управлением статусами визитов и контролем депозитов.
